...
static char vcid[] = "$Id: put_data.c,v 5.14.2.31 2010/04/02 23:20:07 vicadmin Exp $";
                      ...
                      out_data_struct  *out_data)
{
  ...
  out_data[OUT_RUNOFF].data[0]   += cell.runoff * AreaFactor;
   ...
   /** record water table **/
  out_data[OUT_ZWT].data[0]   += cell.wtable * AreaFactor;
  ...
  *****************************/
  ...
  /** record ice water equivalence **/
  out_data[OUT_IWE].data[0] += snow.iwq * 1000. * AreaFactor;
  ...
  out_data[OUT_GLACIER_MELT].data[0] += snow.glmelt * AreaFactor * 1000.;
  
 
  // printf("glmelt_out snmelt_out : %f %f\n",out_data[OUT_GLACIER_MELT].data[0],out_data[OUT_SNOW_MELT].data[0]);
                      ...
                      out_data_struct  *out_data)
{
  ...
  **********************************/
  ...
  /** record band glacier melt **/

  out_data[OUT_GL_MELT_BAND].data[band] += snow.glmelt * Cv * 1000;
