...
static char vcid[] = "$Id: vicNl.c,v 5.14.2.16 2010/04/29 03:00:12 vicadmin Exp $";
  ...
  while(!MODEL_DONE) {
	...
	******************************************/
	...
	for(i=0;i<MAX_NODES;i++) {
      ...
      // free((char *)soil_con.BandIceMove);
      //free((char *)soil_con.BandIwq);
      // free((char *)soil_con.BandIceDepth);
