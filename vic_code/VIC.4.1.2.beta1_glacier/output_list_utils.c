...
static char vcid[] = "$Id: output_list_utils.c,v 5.4.2.15 2010/04/02 23:20:07 vicadmin Exp $";
...
*************************************************************/
  ...
  strcpy(out_data[OUT_GL_MELT_BAND].varname,"OUT_GL_MELT_BAND");             /* snow melt [mm] (ALMA_OUTPUT: [mm/s]) */
